            ...
            <div>
                ...
                >
                        ...
                        {(data) => {
                            ...
                            return (
                                <div>
                                    ...
                                    <SvgProxy selector="#arm1" transform={`translate(0 ${data.y * 0.5})`} />
                                    <SvgProxy selector="#arm2" transform={`translate(0 ${-data.y * 0.5})`} />
                                    <SvgProxy selector="#leg1" transform={`translate(0 ${data.leg1})`} />
                                    <SvgProxy selector="#leg2" transform={`translate(0 ${data.leg2})`} />
                                </div>
                            );
                        }}
                    </Animate>
                    ...
                    >
                        {(data) => (
                            <div>
                                <SvgProxy selector="#head" transform={`rotate(${data.headRotation} 134 176)`} />
                                <SvgProxy selector="#steam:nth-child(odd)" fill-opacity={data.steamOpacity} />
                                <SvgProxy selector="#steam:nth-child(even)" fill-opacity={1 - data.steamOpacity} />
                            </div>
                        )}
                    </Animate>
                </Samy>
